function initCyberpunk() {
  ...
  if (stickyBtn && heroSection) {
    window.addEventListener('scroll', () => {
      ...
      const footerElements = document.querySelectorAll('footer, .elementor-location-footer, .site-footer, .site-below-footer-wrap, .cp-cta-section');
      ...
      // Show sticky button only if we've scrolled past half the hero AND the footer is not visible
