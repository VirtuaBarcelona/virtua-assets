document.addEventListener("DOMContentLoaded", () => {
                ...
                for (let i = 0; i < 40; i++) {
                    ...
                    p.innerHTML = '<div class="alice-petal-inner"></div>';
                ...
                // ========================================
                // 4. FLOATING OBJECTS SCROLL-SCRUBBED PARALLAX
                // ========================================
                ...
                document.querySelectorAll('.alice-chapter-img').forEach(img => {
                    gsap.to(img, {
                        ...
                        ease: 'none',
                        scrollTrigger: {
                            trigger: img.closest('.alice-chapter'),
                            start: 'top 90%',
                            end: 'bottom 10%',
                            scrub: 2
                        }
                ...
                // ========================================
                // 4. CRYSTALLIZE STAGGERED ANIMATIONS
                // ========================================
                ...
                // ========================================
                // 7. STICKY CTA — FOOTER EVASOR
                // ========================================
                const stickyBtn = document.getElementById('alice-btn-sticky');
                const wave = document.querySelector('.alice-radial-wave');

                setTimeout(() => {
                    if (stickyBtn) document.body.appendChild(stickyBtn);
                    if (wave) document.body.appendChild(wave);
                }, 500);
                ...
                if (stickyBtn) {
                    stickyBtn.addEventListener('click', (e) => {
                        ...
                        gsap.set(wave, { scale: 0, opacity: 1 });
                        gsap.to(wave, {
                            scale: 400,
                            duration: 1.2,
                            ease: "power3.in",
                            onComplete: () => {
                                window.location.href = 'https://virtuabarcelona.com/reservas_virtua/';
                            }
                        });
                    });
                    ...
                    if (ctaSection) {
                        window.addEventListener('scroll', () => {
                            ...
                            if (rect.top <= window.innerHeight) {
                                stickyBtn.classList.add('alice-hidden');
                            } else {
                                stickyBtn.classList.remove('alice-hidden');
                            }
                        });
                    }
                }
                ...
                // ========================================
                // 9. PAGE-TURN CHAPTER ANIMATIONS
                // ========================================
                ...
                // Chapter bodies: 3D page-turn entrance
                document.querySelectorAll('.alice-chapter').forEach((ch, i) => {
                    const body = ch.querySelector('.alice-chapter-body');
                    if (!body) return;
