...
function initGalleryDesktop() {
  ...
  const getScrollAmount = () => {
    ...
    // Agregamos un poco de padding al final para que la última imagen se vea centrada
    const extraPadding = windowWidth * 0.1;
    return Math.max(0, trackWidth - windowWidth + extraPadding);
  };
