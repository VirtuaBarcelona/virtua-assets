...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const volState = { dia: 1, tarde: 0, noche: 0, inst: 0 };
    ...
    const tl = gsap.timeline({
        scrollTrigger: {
            ...
            onUpdate: (self) => {
                ...
                musicDia.volume(volState.dia * volMod);
                musicTarde.volume(volState.tarde * volMod);
                musicNoche.volume(volState.noche * volMod);
                musicInstrumental.volume(volState.inst * volMod);
            }
        }
    });
    ...
    tl.to(volState, { dia: 0, tarde: 1, duration: 4 }, "tarde-start");
    ...
    tl.to("#srv-radio-text", {
        text: "> Intercepted transmission...<br>> Is anyone there?<br>> We need extraction.<br>> Coordinates: 41°23'N 2°10'E<br>> ...<br>> [STATIC]",
        duration: 3,
        ease: "none",
    ...
    tl.to("#srv-radio-text", {
        text: "> DATA:<br>> DIFFICULTY: 5/10 | PLAYERS: 2-6<br>> TIME: 60 MIN | AGE: +10<br>> TAGS: SURVIVAL, INVESTIGATION",
        duration: 3,
        ease: "none",
    ...
    tl.to(volState, { tarde: 0, noche: 1, duration: 4 }, "noche-start");
    ...
    tl.to(volState, { inst: 1, duration: 2 }, "torch-in");
    tl.to("#srv-torch", { 
